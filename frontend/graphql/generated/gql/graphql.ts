...
export type AdminUserListItemFieldsFragment = { id: number, fullName: string, email: string, phone: string | null, role: UserRole, country: string | null, isDeleted: boolean, suspended: boolean, isBlocked: boolean, lastActiveAt: string | null, createdAt: string, applicantStatus: ApplicantStatus | null, teacherIsApproved: boolean | null, teacherIsEvaluator: boolean | null, studentHasParentLink: boolean | null, studentHasActiveSubscription: boolean | null, parentLinkedChildrenCount: number | null };
...
export type AdminUsersQuery_adminUsers_items = { id: number, fullName: string, email: string, phone: string | null, role: UserRole, country: string | null, isDeleted: boolean, suspended: boolean, isBlocked: boolean, lastActiveAt: string | null, createdAt: string, applicantStatus: ApplicantStatus | null, teacherIsApproved: boolean | null, teacherIsEvaluator: boolean | null, studentHasParentLink: boolean | null, studentHasActiveSubscription: boolean | null, parentLinkedChildrenCount: number | null };
